...
function readyVoyagersForm() {
	...
	let shipTraits = ['','andorian','borg','breen','cardassian','emp','explorer','ferengi','freighter','hologram','klingon','romulan','ruthless','scout','spore_drive','terran','tholian','transwarp','vulcan','warship'];
